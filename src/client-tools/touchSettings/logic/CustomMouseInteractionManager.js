...
export default class CustomMouseInteractionManager {
  ...
  #handleMouseDown(event) {
    ...
    if (!isDouble) {
      ...
      }, CustomMouseInteractionManager.LONG_PRESS_DURATION_MS);
    }
...
export const canvasCallbacks = (canvas) => {
  return {
    clickLeft: canvas._onClickLeft.bind(canvas),
    clickLeft2: canvas._onClickLeft2.bind(canvas),
    clickRight: canvas._onClickRight.bind(canvas),
    clickRight2: canvas._onClickRight2.bind(canvas),
    dragLeftStart: canvas._onDragLeftStart.bind(canvas),
    dragLeftMove: canvas._onDragLeftMove.bind(canvas),
    dragLeftDrop: _onDragLeftDrop.bind(canvas),
    dragLeftCancel: _onDragLeftCancel.bind(canvas),
    dragRightStart: null,
